        ...
        while($row = mysql_fetch_array($result))
          {
            ...
            echo '<td><div align="center"><a title ="Click to view courses" href="viewrecord.php?username='.$row['username'].'">View Record</a> | <a href="#" id="'.$row['id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
            echo '</tr>';
          }
        ?> 
      </tbody>
