				...
				while($row = mysql_fetch_array($result))
					{
						...
						echo '<td><div align="center"><a href="viewcourses.php?instructor='.$row['username'].'" title="Click To view">View Course</a></div></td>';
						echo '<td><div align="center"> <a href="#" id="'.$row['id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';echo '</tr>';
					}
				?> 
			</tbody>
		</table>
